...
export default function PaymentPage() {
  ...
  async function handleUpload() {
    if (!file) { setUploadError("Screenshot select karein"); return; }
    setUploading(true);
    setUploadError("");
    try {
      ...
      <div className="max-w-3xl mx-auto space-y-6">
        ...
        {paid && (
          <div className="bg-green-50 border border-green-200 rounded-2xl p-6 text-center animate-pulse">
            ...
            <h2 className="text-xl font-bold text-green-700">Payment Verify Ho Gayi!</h2>
            <p className="text-green-600 mt-1 mb-4">Aapki subscription active ho gayi hai.</p>
        ...
        {invoice.status === "REJECTED" && (
          <div className="bg-red-50 border border-red-200 rounded-2xl p-5">
            <div className="flex items-start gap-3">
              ...
              <div>
                <p className="font-semibold text-red-700">Payment Reject Hui</p>
        ...
        {invoice.status === "PENDING" && invoice.hasScreenshot && !uploadDone && (
          <div className="bg-yellow-50 border border-yellow-200 rounded-2xl p-4 flex items-center gap-3">
            ...
            <p className="text-yellow-800 font-medium text-sm">
              Payment screenshot receive ho gayi. 24 ghante mein verify karenge.
            </p>
          </div>
        )}
        ...
        {settings?.whatsappNumber && (
          <div className="bg-yellow-50 border border-yellow-200 rounded-2xl p-5">
            <h3 className="font-semibold text-yellow-800 mb-3">Payment karne ke baad:</h3>
            <ol className="text-sm text-yellow-700 space-y-2 list-decimal list-inside">
              <li>Screenshot + Invoice ID WhatsApp karein</li>
              <li>Bank transfer kiya hai toh account name bhi bhejein</li>
            </ol>
        ...
        {invoice.status === "PENDING" && !paid && (
          <div className="bg-white rounded-2xl border border-gray-200 shadow-sm p-6">
            <h3 className="font-semibold text-gray-900 mb-4">Payment Screenshot Upload Karein</h3>

            {uploadDone ? (
              <div className="bg-green-50 border border-green-200 rounded-xl p-4 text-center">
                <p className="text-green-700 font-medium">✅ Screenshot uploaded! Admin verify karega.</p>
                <p className="text-green-600 text-sm mt-1">Status auto-refresh hoga (har 30 seconds).</p>
              </div>
            ) : (
        ...
        {waUrl && invoice.status === "PENDING" && (
          ...
          >
            ...
            Payment Screenshot WhatsApp Pe Bhejein
          </a>
        )}
      </div>
    </div>
